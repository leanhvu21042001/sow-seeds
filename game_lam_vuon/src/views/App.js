...
function App() {
  ...
  const [seedProducts] = useState(() => {
    return [{
      ...
      price_of_seeds: 10,
      price_of_plant: 20,
      img_forSeed: 'Eschscholzia_Seeds.png',
      img_forPlant_lv1: 'plant.png',
      img_forPlant_lv2: 'Eschscholzia.png',
      timeToGrowUp: 3,
      timeFromLv1ToLv2: 2,
      timeFromLv2ToLv1: 2
    },
    {
      ...
      price_of_seeds: 20,
      price_of_plant: 30,
      img_forSeed: 'MorningGlory_Seeds.png',
      img_forPlant_lv1: 'plant.png',
      img_forPlant_lv2: 'MorningGlory.png',
      timeToGrowUp: 3,
      timeFromLv1ToLv2: 5,
      timeFromLv2ToLv1: 5
    },
    {
      ...
      price_of_seeds: 30,
      price_of_plant: 40,
      img_forSeed: 'Pansy_Seeds.png',
      img_forPlant_lv1: 'plant.png',
      img_forPlant_lv2: 'Pansy.png',
      timeToGrowUp: 3,
      timeFromLv1ToLv2: 5,
      timeFromLv2ToLv1: 5
    },
    {
      ...
      price_of_seeds: 40,
      price_of_plant: 50,
      img_forSeed: 'Rose_Seeds.png',
      img_forPlant_lv1: 'plant.png',
      img_forPlant_lv2: 'Rose.png',
      timeToGrowUp: 3,
      timeFromLv1ToLv2: 5,
      timeFromLv2ToLv1: 5
    },
    {
      ...
      price_of_seeds: 50,
      price_of_plant: 60,
      img_forSeed: 'Sunflower_Seeds.png',
      img_forPlant_lv1: 'plant.png',
      img_forPlant_lv2: 'Sunflower.png',
      timeToGrowUp: 5,
      timeFromLv1ToLv2: 8,
      timeFromLv2ToLv1: 10
    }]
